...
Revision ID: c3491fade9a7
Revises: 
Create Date: 2024-02-21 18:12:13.746726
...
def upgrade():
    ...
    sa.Column('text2summarize', sa.Text(), nullable=True),
    sa.Column('text2summarize_hash', sa.String(length=64), nullable=True),
    sa.Column('openAIsummary', sa.Text(), nullable=True),
    sa.Column('openAItitle', sa.String(length=1024), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('text2summarize_hash')
    )
